...
public class HelperSubmitMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_CONGRATS);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_CONGRATS);
        sendMessage.setReplyMarkup(createKeyboard());
        helperService.sendSubmit(update);
