...
public class HelperSexMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_PASSPORT_TYPE);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_PASSPORT_TYPE);
        sendMessage.setReplyMarkup(createKeyboard(Buttons.PASSPORT_TYPE));
        helperService.sendHelperSex(update);
