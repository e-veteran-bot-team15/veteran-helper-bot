...
public class HelperPhoneNumberMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_EMAIL);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_EMAIL);
        sendMessage.setReplyMarkup(createKeyboard());
        helperService.sendPhone(update);
