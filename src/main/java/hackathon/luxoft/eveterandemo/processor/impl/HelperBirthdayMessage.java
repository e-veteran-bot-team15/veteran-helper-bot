...
public class HelperBirthdayMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_SEX);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_SEX);
        sendMessage.setReplyMarkup(createKeyboard(Buttons.USER_SEX));
        helperService.sendHelperBirthday(update);
