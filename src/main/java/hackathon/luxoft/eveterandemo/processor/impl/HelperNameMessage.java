...
public class HelperNameMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_IPN);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_IPN);
        sendMessage.setReplyMarkup(createKeyboard());
        helperService.sendHelperName(update);
