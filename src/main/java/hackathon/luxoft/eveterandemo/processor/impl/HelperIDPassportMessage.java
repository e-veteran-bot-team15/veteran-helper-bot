...
public class HelperIDPassportMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_IDPASSPORT);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_IDPASSPORT);
