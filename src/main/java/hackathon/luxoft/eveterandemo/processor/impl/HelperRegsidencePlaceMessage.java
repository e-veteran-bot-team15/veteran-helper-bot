...
public class HelperRegsidencePlaceMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_RESIDENCE_PLACE);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_PLACE_RESIDENCE);
        sendMessage.setReplyMarkup(createKeyboard());
        helperService.sendHelperResidencePlace(update);
