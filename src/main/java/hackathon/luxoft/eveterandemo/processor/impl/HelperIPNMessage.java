...
public class HelperIPNMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_BIRTHDAY);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_BIRTHDAY);
        sendMessage.setReplyMarkup(createKeyboard());
        helperService.sendHelperIPN(update);
