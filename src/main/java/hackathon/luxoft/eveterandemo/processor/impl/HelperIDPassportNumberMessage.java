...
public class HelperIDPassportNumberMessage extends MessageProcessor {
    ...
    public SendMessage process(Update update) {
        botStateManager.setState(update.getMessage().getChatId(),BotState.VETERAN_INPUT_ISSUED_DATE);
        SendMessage sendMessage = createMessage(update, Messages.HELPER_USER_ISSUED_DATE);
        sendMessage.setReplyMarkup(createKeyboard());
        helperService.sendHelperIDPassportNumber(update);
